...
appRouter.beforeEach((to, form, next) => {
  // 从from跳转到to
  document.title = to.matched[0].meta.title || 'webpack'; // 跳转后title修改为改路由名字，嵌套后不能直接拿到meta，所以取matched[0]
...
// 报错：路由中点击路径重复，也有可能是安装的vue-router还是之前出错的那个版本
// https://my.oschina.net/u/4343285/blog/4335033
